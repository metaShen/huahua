...
public class Page<T> {
	...
	/** 分页信息 */
	private cn.edu.xmut.core.persistence.Pageable pageable;
	...
	public Page() {
		this.total = 0L;
		this.pageable = new cn.edu.xmut.core.persistence.Pageable();
	}
	 ...
	 *            分页信息
	 */
	public Page(List<T> content, long total, cn.edu.xmut.core.persistence.Pageable pageable) {
		if(content == null) {
