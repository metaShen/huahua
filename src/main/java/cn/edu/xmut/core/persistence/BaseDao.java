...
public interface BaseDao<T> {
	 ...
	 * @return
	 */
	public long countBySql(String sqlString, Class<?> resultClass, Object... parameter);
	 ...
	 * @return 分页对象
	 */
	public Page<T> search(Pageable page, BooleanQuery query, BooleanQuery queryFilter, Sort sort);
