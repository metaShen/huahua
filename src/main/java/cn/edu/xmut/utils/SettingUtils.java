...
import cn.edu.xmut.core.config.Config;
import cn.edu.xmut.core.config.Setting;
...
public final class SettingUtils {
	...
	static {
		...
		dateConverter.setPatterns(Config.DATE_PATTERNS);
	...
	public static Setting get() {
		...
		Setting setting;
		net.sf.ehcache.Element cacheElement = null;
		if (cache != null) {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File shopxxXmlFile = new ClassPathResource(Config.SHOPXX_XML_PATH).getFile();
